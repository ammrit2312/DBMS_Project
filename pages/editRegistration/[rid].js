...
const editRegistration = () => {
    ...
    useEffect(() => {
        axios.post(`http://127.0.0.1:5000/property/info`, {id: rid}).then(res => {
            let data = res.data.data;
            setPropertyAddr(data.p_address);
            setPropertySize(data.p_size);
            setPropertyPrice(data.rent);
            setPropertyArea(data.p_area);
            setPropertyNearby(data.p_nearby);
            setFacility(data.p_facility);
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://127.0.0.1:5000/edit/property',{data}).then(res => {
            console.log(res);
    ...
    const form_data = [form_data_1, form_data_2, form_data_4];
